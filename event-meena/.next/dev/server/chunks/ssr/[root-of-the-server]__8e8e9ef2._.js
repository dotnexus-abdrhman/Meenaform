...
function ResponseForm({ event, participantInfo, isPreviewMode = false }) {
    ...
    const [responseId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$uuid$2f$dist$2d$node$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])());
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const response = {
                id: responseId,
                eventId: event.id,
                participant: finalParticipantInfo,
                answers,
                status: "completed",
                timeSpent,
                progress: 100,
                metadata: {
                    ...
                    os: getOSInfo(),
                    language: "ar",
                    sessionId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$uuid$2f$dist$2d$node$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()
                },
                startedAt: startTime.toISOString(),
                completedAt: endTime.toISOString(),
                lastUpdatedAt: endTime.toISOString()
            };
            // Save response (mock for now)
            console.log("Response submitted:", response);
            // Store in localStorage for now
            const existingResponses = JSON.parse(localStorage.getItem("event_responses") || "[]");
            existingResponses.push(response);
            localStorage.setItem("event_responses", JSON.stringify(existingResponses));
            setIsSubmitted(true);
            toast({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8e8e9ef2._.js.map