...
"[project]/event-meena/lib/pdf-export.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/event-meena/node_modules/jspdf/dist/jspdf.es.min.js [app-ssr] (ecmascript)");
...
const exportSingleTablePDF = async (eventTitle, responses, components, config)=>{
  ...
  `;
    ...
    try {
        ...
        // Create PDF
        const doc = new __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]({
        ...
        filteredComponents.forEach((component, index)=>{
            ...
            if (component.type === "signature") {
                ...
                if (answer && typeof answer.answer === 'object' && answer.answer !== null) {
                    const signatureAnswer = answer.answer;
...
const exportCustomTablesPDF = async (eventTitle, responses, components, config, editorSettings // Optional: Advanced editor settings
    ...
    for(let tableIndex = 0; tableIndex < validTables.length; tableIndex++){
        ...
        const tableComponents = components.filter((c)=>table.componentIds.includes(c.id) && (c.type === "question" || c.type === "rating" || c.type === "signature"));
    ...
    `;
      ...
      `;
        ...
        let canvas;
        try {
            canvas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$html2canvas$2f$dist$2f$html2canvas$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(container, {
                scale: qualityScale,
                useCORS: true,
                allowTaint: true,
...
"[project]/event-meena/lib/pdf-template-validator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function validatePDFSettings(data) {
    ...
    if (!data.fonts || typeof data.fonts !== 'object') {
        ...
        const validFonts = __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$types$2f$pdf$2d$editor$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AVAILABLE_FONTS"].map((f)=>f.value);
...
"[project]/event-meena/lib/pdf-performance.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/event-meena/lib/excel-export.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/event-meena/node_modules/xlsx/xlsx.mjs [app-ssr] (ecmascript)");
...
const exportSingleSheetExcel = (eventTitle, responses, components, config)=>{
    const workbook = __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].book_new();
    // Prepare data array
    const data = [];
    ...
    if (config.includeExportDate) {
        data.push([
            `تاريخ التصدير: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), "PPP", {
    ...
    responses.forEach((response)=>{
        ...
        if (config.includeParticipationDate) {
            ...
            row.push(date ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(date), "PPP", {
                locale: __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$locale$2f$ar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ar"]
            }) : "");
        }
    ...
    // Create worksheet
    const worksheet = __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].aoa_to_sheet(data);
    // Apply styling (basic - XLSX has limited styling support)
    const range = __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].decode_range(worksheet['!ref'] || 'A1');
    // Set column widths
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(workbook, worksheet, "النتائج");
    ...
    if (config.includeSummarySheet) {
        const summaryData = [
            ...
            [
                "تاريخ التصدير",
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), "PPP", {
                    locale: __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$locale$2f$ar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ar"]
                })
            ]
        ];
        ...
        const summarySheet = __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].aoa_to_sheet(summaryData);
        __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(workbook, summarySheet, "الملخص");
    }
    // Generate file and download
    const fileName = `${eventTitle.replace(/\s+/g, "-")}-results-${new Date().toISOString().split("T")[0]}.xlsx`;
    __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeFile"](workbook, fileName);
};
const exportSeparateSheetsExcel = (eventTitle, responses, components, config)=>{
    ...
    responses.forEach((response, index)=>{
        ...
        if (config.includeParticipationDate) {
            const date = response.completedAt || response.startedAt;
            data.push([
                `التاريخ: ${date ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(date), "PPP", {
                    locale: __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$date$2d$fns$2f$locale$2f$ar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ar"]
                }) : ""}`
            ]);
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(workbook, worksheet, sheetName);
    });
    // Generate file and download
    const fileName = `${eventTitle.replace(/\s+/g, "-")}-results-${new Date().toISOString().split("T")[0]}.xlsx`;
    __TURBOPACK__imported__module__$5b$project$5d2f$event$2d$meena$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeFile"](workbook, fileName);
...
//# sourceMappingURL=event-meena_lib_98552010._.js.map